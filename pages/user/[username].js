                ...
                <div className="order-2 lg:pl-4 flex pt-4 lg:pt-0 font-semibold lg:text-base text-sm">
                  <div className="flex flex-row justify-around container">
                    <div className="flex order-1">
                      <h2 className="pr-2 text-white">Followers </h2>
                      <p className="bg-slate-900 h-fit border-2 rounded border-slate-700 px-2 text-white">
                        {user.followers ? user.followers.length : 0}
                      </p>
                    </div>

                    <div className="flex order-2">
                      <h2 className="pr-2 text-white">Reviews</h2>
                      <p className="bg-slate-900 h-fit border-2 rounded border-slate-700 px-2 text-white">
                        {reviews.length}
                      </p>
                    </div>
                    ...
                    <div className="flex order-3">
                      <h2 className="pr-2 text-white">Average Rating</h2>
                      <p className="bg-slate-900 h-fit border-2 rounded border-slate-700 lg:px-2 px-1 text-white">
                      ...
                      <div id="editPic" className="flex order-1">
                        <Dialog.Root>
                          <Dialog.Trigger asChild>
                            <button className="bg-slate-900 px-2 rounded-lg border-2 border-slate-700 font-bold hover:border-slate-900 hover:bg-slate-700 hover:text-black text-white">
                                ...
                                <div className="flex mt-16 justify-end ">
                                  <Dialog.Close asChild>
                                    <button
                                      ...
                                      className="bg-slate-900 px-2 rounded-lg border-2 mb-2 border-slate-700 font-bold hover:border-slate-900 hover:bg-slate-700 hover:text-black text-white"
                                    >
                                      Save changes
                                    </button>
                                  </Dialog.Close>
                      ...
                      <div id="follow" className="flex order-1 pl-10">
                        {!following ? (
                          <button
                            ...
                            className="bg-slate-900 px-2 rounded-lg border-2 border-slate-700 font-bold hover:border-slate-900 hover:bg-slate-700 hover:text-black text-white"
                          >
                            Follow
                          </button>
                        ) : (
                        ...
                        <div className="order-1  w-full h-12  rounded-t-lg   border-b-2 border-b-slate-700">
                          <div className="flex flex-row ">
                            <div className="flex order-1 w-full">
                              <div className=" flex inset-x-0 top-0 justify-start float-left cursor-pointer">
                                {review.userImage ? (
                                  <Image
                                    alt="userImage"
                              ...
                              <div className="flex flex-col">
                                <div className="pl-2 flex cursor-pointer w-fit order-1">
